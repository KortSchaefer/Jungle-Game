    ...
    <section class="main-column">
      ...
      <section id="treesPanel" class="tab-panel is-active">
        ...
        <div class="ui-card">
          ...
          <p id="treeHealthText">Health: 100%</p>
          <p id="treeQualityText">Quality: 1.00x</p>
          <button id="maintenanceBtn" type="button" title="Spend cash to restore tree health and quality">Buy Maintenance</button>
        </div>
        ...
        <div class="ui-card">
          ...
          <label class="toggle-row" for="productionModeSelect">
            <span>Production Mode</span>
            <select id="productionModeSelect">
              <option value="highest">Highest Type</option>
              <option value="blend">Blend</option>
            </select>
          </label>
          <div id="bananaInventoryList" class="buyers-list"></div>
        </div>
      </section>
